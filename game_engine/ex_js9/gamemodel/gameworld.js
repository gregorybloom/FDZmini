...
GameWorld.prototype.update = function() {
    ...
    if(GAMEMODEL.currentLevel != GAMEMODEL.goToLevel) {
			if(this.dropper instanceof DropperActor && this.dropper.savedCheckpt)        LEVELLOADER.loadLevel(GAMEMODEL.goToLevel,this.dropper.savedCheckpt);
			else        LEVELLOADER.loadLevel(GAMEMODEL.goToLevel);
    }
