...
var classLoadList = ["BufferLoader"];
...
GAMESOUNDS.init = function()
{
  ...
  GAMESOUNDS.load();
	GAMESOUNDS.loadSounds( GAMESOUNDS.audioContext, GAMESOUNDS.gameSFX );
...
GAMESOUNDS.loadSounds = function(context, soundlist,fn) {
  if(typeof fn === "undefined" || fn == null)   fn=onLoaded;

  var ctx = this;
  var loader = new BufferLoader(context, soundlist, fn);
